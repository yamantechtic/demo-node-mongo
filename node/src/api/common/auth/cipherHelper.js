...
const ttl = process.env.RESET_PASSWORD_SECRET_TTL;
const algorithm = process.env.RESET_PASSWORD_SECRET_ALGORITHM;
const inputEncoding = process.env.RESET_PASSWORD_SECRET_INPUT_ENCODING;
const outputEncoding = process.env.RESET_PASSWORD_SECRET_OUTPUT_ENCODING;
